...
{
    public class TeklifIslemleriMap : EntityTypeConfiguration<TeklifIslemleri>
    {
        public TeklifIslemleriMap()
        {
            ToTable("TeklifIslemleriTablosu");
